...
class EventRouterTest extends \Codeception\Test\Unit
{
    ...
    public function testReadSimple()
    {
        ...
        $accessor = new EventRouter($input);
        ...
        try {
            ...
            $this->assertEquals(EventRouterException::CANNOT_GET_VALUE, $e->getCode());
    ...
    public function testReadFromNonAssocArray()
    {
        ...
        $accessor = new EventRouter($source);
    ...
    public function testWriteSimple()
    {
        ...
        try {
            ...
            $this->assertEquals(EventRouterException::CANNOT_SET_VALUE, $e->getCode());
    ...
    public function testBadSource()
    {
        $input = 123;
        try {
            new EventRouter($input);
            $this->expectError();
        } catch(EventRouterException $e) {
            $this->assertEquals(EventRouterException::SOURCE_IS_SCALAR, $e->getCode());
